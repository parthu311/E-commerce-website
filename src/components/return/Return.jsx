...
const Return = () => {
  return (
    <>
    <Navbar/>
    <div style={{padding:'40px 200px', fontSize:'1rem'}} className="container">
  <style
  ...
  <div data-custom-class="body">
            ...
            <span style={{ color: "rgb(89, 89, 89)" }}>
              <strong>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">February 13, 2024</bdt>
                </span>
              </strong>
            </span>
          </span>
    ...
    <div>
      ...
      >
        ...
        >
          ...
          days of the purchase date. All returned items must be in new and
        ...
        >
          ...
          >
            <bdt data-type="conditional-block">
              ...
              <bdt data-type="body">
                ...
                <bdt className="block-component" />
                Authorization
                <bdt className="statement-end-if-in-editor" /> (RMA) number.
          ...
          >
            <bdt data-type="conditional-block">
              ...
              />
              <bdt data-type="body">
                &nbsp;and include your proof of purchase, then
              </bdt>
            </bdt>
            <bdt data-type="conditional-block">
              <bdt
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          >
            ...
            , <bdt className="block-component" />
            <bdt className="block-component" />
            <bdt className="question">GUJARAT</bdt>
    ...
    <div>
            ...
            >
              ...
              >
                <bdt data-type="conditional-block">
                  ...
                  />
                  <bdt data-type="body">
                    Return shipping charges will be paid or reimbursed by
                    us.&nbsp;
                  </bdt>
                </bdt>
                <bdt className="statement-end-if-in-editor" data-type="close" />
      ...
      <div data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
          <bdt className="question">parthradadiya433@gmail.com</bdt>
        </span>
      </div>
      <style
        dangerouslySetInnerHTML={{

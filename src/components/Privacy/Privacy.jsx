...
const Privacy = () => {
  return (
    <>
    <Navbar/>
    <div className="container-fluid bg-gray-200 py-5 px-8 rounded-lg shadow-md">
  ...
  <ul>
    ...
    <li>
      <p>
        ...
        Us or Our in this Agreement) refers to E-Bharat.
      </p>
    </li>
    <li>
      <p>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to E-Bharat, accessible from{" "}
        <a href="Ebharat.in" rel="external nofollow noopener" target="_blank">
          Ebharat.in
        </a>
      </p>
    </li>
  ...
  <p>
    Usage Data may include information such as Your Devices Internet Protocol
  ...
  <ul>
    <li>By email: parthradadiya433@gmail.com</li>
  </ul>
  </div>
  <Footer/>
</>
